...
describe "Agworld Requirements" do
  ...
  it 'should calculate everything correctly' do
    ...
    calculator.bind( :B65 => calculator.evaluate( '=4.6*B64^0.393' ) )
    calculator.bind( :B66 => calculator.evaluate( '=B65-B63' ) )
    calculator.bind( :B67 => calculator.evaluate( '=2.6+0.0012*B64' ) )
    calculator.bind( :B68 => calculator.evaluate( '=B66*B67' ) )
    calculator.bind( :B69 => calculator.evaluate( '=0.27*B68-0.0008*B68^2' ) )
    calculator.bind( :B70 => 3.99 )
    calculator.bind( :B71 => 0.9 )
    calculator.bind( :B72 => calculator.evaluate( '=((59690-60*B64+0.03*B64^2)/100000)+0.15' ) )
    calculator.bind( :B73 => calculator.evaluate( '=B14*B70/B71/B72' ) )
    calculator.bind( :B74 => calculator.evaluate( '=B69+B73' ) )
    calculator.bind( :B75 => calculator.evaluate( '=IF(B74<0,0,IF(B74<5,5,B74))' ) )
